...
part of 'dynamics_state_class.dart';
...
mixin _$DynamicsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<DynamicsEntity> dynamics) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<DynamicsEntity> dynamics)? loaded,
...
abstract class Initial implements DynamicsState {
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<DynamicsEntity> dynamics});
}
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(final List<DynamicsEntity> dynamics)
      : _dynamics = dynamics;

  final List<DynamicsEntity> _dynamics;
  @override
  List<DynamicsEntity> get dynamics {
  ...
  @override
  String toString() {
    return 'DynamicsState.loaded(dynamics: $dynamics)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_dynamics));
...
abstract class Loaded implements DynamicsState {
  const factory Loaded(final List<DynamicsEntity> dynamics) = _$LoadedImpl;
...
class __$$ErrorImplCopyWithImpl<$Res>
    extends _$DynamicsStateCopyWithImpl<$Res, _$ErrorImpl>
...
class _$ErrorImpl implements Error {
  ...
  @override
  String toString() {
    return 'DynamicsState.error(message: $message)';
  }
...
abstract class Error implements DynamicsState {
